...
==========================================
*/
var document, console, Codebird, window;
...
(function () {
    ...
    //Codebird init
    var cb = new Codebird();
    cb.setConsumerKey("L5QNhGfZs6ECPTfORH0QKwtaw", "u9U8bviYkyw3YeOj5iEjgPoFg4CtErzMaZQuJFSlaZJcVvymXo");
    ...
    */
    ...
    var userButton = document.getElementsByClassName("btn-user"); //user button
    var loadButton = document.getElementsByClassName("btn-load"); //load more button
    var feed = document.getElementsByClassName("feed"); //feed div
    var bio = document.getElementsByClassName("bio"); //bio div
    var loader = document.getElementById("spin"); //css loader
    var tweetCount, tweets;
